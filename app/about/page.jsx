        ...
        <div className="max-w-4xl px-5 mx-auto mt-16 ">
            <div className="text-center">
                ...
                <p className="max-w-md mx-auto mt-2 text-gray-500">
                    Easily customize your forms with our user-friendly interface. No coding skills are required, and our comprehensive documentation helps you get started quickly.
                </p>
            </div>
            <div className="grid gap-10 mt-10 md:grid-cols-2">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">
                            Enjoy a seamless experience on any device. AI Form Builder is optimized for mobile, tablet, and desktop, ensuring your forms look great everywhere.
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500"> Our dedicated support team and community are here to assist you. Premium support is available for sponsors during weekdays, ensuring your issues are promptly addressed.
                        </p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500"> AI Form Builder is designed to work flawlessly across all modern browsers, including Chrome, Firefox, and Safari, providing a consistent user experience..</p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                    <span className="p-3 rounded-full text-violet-600 bg-violet-500/10">
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500">We adhere to strict coding standards and perform thorough testing to ensure clean, readable, and maintainable code, making your development process smooth and efficient. </p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                    <span className="p-3 rounded-full text-violet-600 bg-violet-500/10">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-gray-500"> he AI Form Builder is actively maintained by our core team. We continuously work on updates and improvements, addressing any reported issues swiftly.</p>
                    </div>
                </div>
            </div>
        </div>
